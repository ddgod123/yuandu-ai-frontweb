        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-8 md:p-10">
          ...
          <article className="prose prose-slate max-w-none text-sm leading-7">
            ...
            <ol>
              ...
              <li>平台尊重并保护知识产权，权利人可通过版权投诉邮箱提交通知。</li>
              <li>平台展示内容不当然构成对该内容完整商业权利的授予。</li>
            </ol>

            <h2>2. 使用风险提示</h2>
            <ol>
              <li>平台资源主要用于个人学习、交流、非商业场景。</li>
              <li>你应自行判断资源是否满足使用目的，并自行承担使用风险。</li>
              <li>因网络状态、设备差异、第三方服务波动导致的异常，平台不承诺绝对无误。</li>
            </ol>

            <h2>3. 观点与时效性</h2>
            <ol>
              <li>表情包内容可能具有创作主观性、语境依赖性和时效性，不代表平台立场。</li>
              <li>对第三方提供或转载内容，平台不对其绝对准确性、完整性、实时性作保证。</li>
            </ol>

            <h2>4. 第三方链接与服务</h2>
            <ol>
              <li>平台可能提供第三方链接，仅为便利用户使用。</li>
            ...
            <ol>
              <li>不可抗力（自然灾害、战争、政府行为、重大网络故障等）导致服务中断；</li>
              <li>电信运营商、云服务、CDN、短信服务等第三方原因导致的损失；</li>
              <li>用户违反法律法规或平台规则造成的后果；</li>
              <li>用户将平台内容用于商业用途或违法用途引发的争议与损失。</li>
            </ol>

            <h2>6. 侵权通知与反通知</h2>
            <ol>
              <li>权利人可提交侵权通知（身份证明、权属证明、侵权链接、具体说明）。</li>
              <li>平台在收到合格材料后，将依法采取必要措施并通知相关方。</li>
