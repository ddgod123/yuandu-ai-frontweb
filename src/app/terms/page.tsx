      ...
      <div className="mx-auto max-w-4xl px-6">
        <div className="rounded-3xl border border-slate-200 bg-white p-8 md:p-10">
          ...
          <article className="prose prose-slate max-w-none text-sm leading-7">
            ...
            <h3>4.1 用户上传内容补充规则</h3>
            <ol>
              <li>你上传表情素材时，不得包含违法违规、涉政极端、色情暴力、恐怖、诈骗等内容。</li>
              <li>你应保证上传内容不侵犯他人著作权、商标权、肖像权、隐私权等合法权益。</li>
              <li>上传即视为你确认对素材拥有合法使用、传播或授权处置权利。</li>
              <li>平台可对上传类型、大小、数量进行技术限制，并有权按平台规则调整。</li>
            </ol>
